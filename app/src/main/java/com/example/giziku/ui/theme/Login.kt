// com/example/giziku/ui/theme/Login.kt
                ...
                if (email.isEmpty() || password.isEmpty()) {
                    ...
                    userViewModel.loginUser(email, password) { user ->
                        if (user != null) {
                            ...
                            // Set currentUserId setelah login berhasil
                            userViewModel.setCurrentUserId(user.id)

                            // Debugging log untuk memastikan currentUserId terisi
                            Log.d("Login", "User ID set: ${user.id}") // Log ID pengguna

                            // Navigasi ke halaman orang tua atau lainnya berdasarkan role
                            when (user.role) {
